package br.com.douglasdjf21.integrationtests.mapper;
...
public class YMLMapper implements ObjectMapper {
	...
	public Object deserialize(ObjectMapperDeserializationContext context) {
		...
		try {
			String dataToDeserializer = context.getDataToDeserialize().asString(); 
			Class type =(Class) context.getType();
			return objectMapper.readValue(dataToDeserializer,typeFactory.constructType(type));
